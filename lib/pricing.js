...
export function recommendTier({ tier3Gated, flagged }) {
  if (tier3Gated) {
    return {
      tier: 'tier2',
      reason:
        'Jūsu sistēmas vecums nozīmē biežāku uzmanību — Komforts plāns nodrošina neierobežotus izsaukumus un prioritāti bez papildu maksas.',
    }
  }
  if (flagged) {
    return {
      tier: 'tier2',
      reason:
        'Sistēmai ilgstoši nav bijusi apkope. Komforts plāns iekļauj neierobežotus izsaukumus, kas sedz to, kas var atklāties pirmajā vizītē.',
    }
  }
  return {
    tier: 'tier3',
    reason:
      'Jūsu sistēma ir labi kopta — Komforts Pilns plāns iekļauj arī daļu izmaksas, kamēr sistēma ir šajā stāvoklī.',
  }
}
