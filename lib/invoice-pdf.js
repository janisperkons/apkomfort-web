...
const styles = StyleSheet.create({
  ...
  payBox: { marginTop: 22, padding: 14, backgroundColor: '#F6F2E9', borderRadius: 6 },
  payLine: { fontSize: 10.5, marginTop: 3 },
  payIban: { fontWeight: 'bold', letterSpacing: 0.5 },
  ...
  return e(Document, null,
    e(Page, { size: 'A4', style: styles.page },
      ...
      e(View, { style: styles.metaRow },
        ...
        e(View, { style: styles.metaBlock },
          e(Text, { style: styles.label }, 'Piegādātājs'),
          e(Text, { style: styles.value }, COMPANY.legalName),
          e(Text, { style: [styles.value, { marginTop: -6 }] }, 'Reģ. Nr. ' + COMPANY.regNr),
          e(Text, { style: [styles.value, { marginTop: -6 }] }, COMPANY.city),
          e(Text, { style: [styles.value, { marginTop: -6 }] }, COMPANY.phone),
          e(Text, { style: [styles.value, { marginTop: -6, fontSize: 9 }] }, COMPANY.email),
        ),
      ...
      e(View, { style: styles.payBox },
        e(Text, { style: styles.label }, 'Apmaksas rekvizīti'),
        e(Text, { style: styles.payLine }, `Saņēmējs: ${COMPANY.legalName}`),
        e(Text, { style: styles.payLine }, `Banka: ${COMPANY.bankName}, SWIFT: ${COMPANY.bankSwift}`),
        e(Text, { style: [styles.payLine, styles.payIban] }, `IBAN: ${COMPANY.iban}`),
        e(Text, { style: styles.payLine }, `Maksājuma mērķis: Rēķins Nr. ${invoice.invoice_number}`),
      ),
      ...
      e(Text, { style: styles.footer }, `${COMPANY.legalName} · Reģ. Nr. ${COMPANY.regNr} · ${COMPANY.city} · ${COMPANY.phone}`),
    ),
  )
}
