...
export const d = v => v ? new Date(v).toLocaleDateString('lv-LV', { day: '2-digit', month: '2-digit', year: 'numeric', timeZone: 'Europe/Riga' }) : '—'
export const dt = v => v ? new Date(v).toLocaleString('lv-LV', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Riga' }) : '—'
